...
## Pøípadné rozšíøení
 ...
 ### Vizualizace tras na mapì
 - Zobrazení strážcemi pokrytých míst na mapì v konkréntí den.

 ### Použité vybavení strážce na den
 - Mezi vybavení patøí kolo, bìžecké lyže, snìžníce, skialpy, záznamové zaøízení (osobní kamera), možnost pøidat další.
 - Støážce mùže vybrat, které z vybavení v daný den použil, souèástí docházky.
 - Vedoucí strážního obvodu si mùže zobrazit èetnost užití urèitého vybavení v urèitém èasovém úseku.
 - Slouží pro posouzení potøeby a užití vybavení.

  ### Statistiky tras ([issue #8](https://github.com/korandom/NP-strazci/issues/8))
 
 - Jako **vedoucí strážního obvodu** chci zobrazit vizualizaci (graf) poètu prùchodù tras v rámci urèitého období, protože chci vìdìt frekvenci procházení tras.
 
 - Jako **vedoucí strážního obvodu** chci zobrazit vizualizaci (graf) - kolikrát byla urèitá trasa navštívena jakými strážci v rámci urèitého období, protože chci vìdìt, jestli je trasa plánovaná pro strážce pøimìøenì rovnomìrnì.

 - Jako **vedoucí strážního obvodu** chci zobrazit vizualizaci (graf) - kolikrát prošel jaké trasy urèitý strážce v rámci urèitého období, protože chci vìdìt, jaké trasy jsou pro urèitého strážce plánované nejvíce a nejménì èasto.
